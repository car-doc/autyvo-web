          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 bg-brand-primary/10 px-4 py-2 rounded-full mb-6">
                ...
                <span className="text-brand-primary font-semibold text-sm uppercase tracking-wide">Fonctionnalités Clés</span>
              </div>
            ...
            <div className="text-center bg-gradient-to-r from-brand-primary to-brand-primary-dark rounded-3xl p-12 shadow-2xl relative overflow-hidden">
              <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iNDAiIGhlaWdodD0iNDAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PGNpcmNsZSBjeD0iMiIgY3k9IjIiIHI9IjEiIGZpbGw9IndoaXRlIiBmaWxsLW9wYWNpdHk9IjAuMSIvPjwvc3ZnPg==')] opacity-30"></div>
              <div className="relative z-10">
                <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
                  Prêt à simplifier la gestion de votre véhicule ?
                </h3>
                <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                  Rejoignez des milliers d'utilisateurs qui ont déjà adopté AUTYVO pour gérer et valoriser leur véhicule.
                </p>
                <button
                  onClick={scrollToDownload}
                  className="inline-flex items-center gap-3 bg-white text-brand-primary px-8 py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 group"
                >
